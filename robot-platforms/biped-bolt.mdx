...
For detailed coordinate system conventions, see [Conventions](/reference/conventions).
...
A dedicated calibration tool is available for the biped. See the [Biped 6dof Calibration Tool](/reference/calibration#biped-6dof) documentation.
...
<CardGroup cols={2}>
  <Card title="Biped Leg Assembly" icon="gear" href="/robot-platforms/legs-and-testbeds">
