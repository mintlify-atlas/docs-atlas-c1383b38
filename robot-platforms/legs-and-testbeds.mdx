...
<CardGroup cols={2}>
  <Card title="2DOF Leg Assembly" icon="gear" href="/robot-platforms/legs-and-testbeds#2dof-leg-v2">
  ...
  <Card title="Test Stand Setup" icon="flask" href="/robot-platforms/legs-and-testbeds#leg-test-stand-v2">
...
<Card title="NYU Finger v1" icon="hand-pointer">
  Three-degree-of-freedom robotic finger using 3DOF leg components
...
<Card title="Dual Motor Testbed v1" icon="vial">
  Simplest mechanical setup for learning brushless motor torque control
...
<CardGroup cols={2}>
  <Card title="Actuator Module Core" icon="circle-dot" href="/actuator-modules/core-v1">
  ...
  <Card title="3D Printing Guide" icon="print" href="/resources/3d-printed-parts">
