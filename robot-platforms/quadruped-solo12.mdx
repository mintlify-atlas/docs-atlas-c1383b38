...
For complete coordinate system conventions, see [Conventions](/mechanics/conventions).

## Robot Calibration

A dedicated calibration tool is available for the Solo12. See the [Quadruped 12dof Calibration Tool](/mechanics/robot-calibration#quadruped-12dof) documentation.
...
- Outdoor terrain navigation (with autonomy upgrade)

## Related Resources

<CardGroup cols={2}>
  <Card title="3DOF Leg Assembly" icon="gear" href="/mechanics/leg-3dof-v1">
